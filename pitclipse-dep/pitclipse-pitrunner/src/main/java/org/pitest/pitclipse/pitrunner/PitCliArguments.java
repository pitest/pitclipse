...
public class PitCliArguments {
	...
	private String[] toCLIArgs(PitOptions options) {
		...
		builder.add("--failWhenNoMutations", "false", "--outputFormats", "HTML,XML", "--verbose", "--threads",
				Integer.toString(threads), "--reportDir", reportDir.getPath(), "--targetTests", testsToRunFrom(options));
